...
export class HomePage {
  plants: Product[] = [
    { name: 'Placa Solar Painel Solar 150w + Manual', valor: "375,10", image: '../../assets/placa.png', link:"https://mpago.la/1YXTHmy" },
    ...
    { name: 'Painel solar portátil Ecoflow 110W', valor: "1.123,30", image: '../../assets/placa4.png',link:"https://mpago.la/2pzdsdm"},
    { name: 'Painel Solar Ezviz D 7.2v 4,2w Para Câmera Externa A Bateria', valor: "195,70", image: '../../assets/placa5.png',link:"https://mpago.la/1LJ1pap" },
    { name: 'String Box Clamper 4 Entradas / 4 Saídas', valor: "2.094,00", image: '../../assets/placa6.webp',link:"https://mpago.la/2fEpYs1" },
    { name: 'Estação Solar Portátil Autônoma 3 Lâmpadas E Carregamento', valor: "259,90", image: '../../assets/placa7.webp',link: "https://mpago.la/2aTTJ2B"},
